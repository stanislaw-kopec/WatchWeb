...
public class WatchComment {
    ...
    protected WatchComment() {
    }

    public WatchComment(Watch watch, User author, WatchComment parent, String content) {
        this.watch = watch;
        this.author = author;
        this.parent = parent;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof WatchComment comment)) {
            return false;
        }
